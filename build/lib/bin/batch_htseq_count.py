...
def batch_run(args):
    ...
    for f in dirs:
        ...
        filename = sample + '/HTSeqCount/' + sample + '.htseq.count.sh'
...
parser.add_argument('--dirpattern',type=str,help='BAM file patter',required=False,default='')
parser.add_argument('--p',type=int,help='Number of threads',default=6)
parser.add_argument('--stranded',type=str,help='yes,no,reverse (default no)',default='no')
