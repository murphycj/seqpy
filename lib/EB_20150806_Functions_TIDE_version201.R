...
decomposition <- function(import,  p.threshold = 0.001, fout="") {
  ...
  ## pvalue calculation (source: https://urldefense.proofpoint.com/v2/url?u=https-3A__www.princeton.edu_-7Eslynch_soc504_mult-5Freg2.pdf&d=BQIGAg&c=lb62iw4YL4RFalcE2hQUQealT9-RXrryqt9KZX2qu2s&r=O3yXKBF_L8Fov58BXORGXKqPP85pYddrOwCg4PV2BCY&m=-feC1nNQy6GFKrvDQ1hmZHK8xR8JHvJSSdWP1jZDVFU&s=DDQlTK-kE5D0fW7OxNMGfCgXjIopCFUynOrXzWMrkg0&e= )
  #standard error:
